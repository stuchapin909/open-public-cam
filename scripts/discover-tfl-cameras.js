#!/usr/bin/env node
/**
 * TfL JamCam Discovery Script
 * 
 * Fetches all TfL traffic cameras via their Place API and generates
 * a camera list for the open-public-cam registry.
 * 
 * Requires a TfL API key (free): https://api-portal.tfl.gov.uk/signup
 * 
 * Usage: TFL_API_KEY=your-key-here node scripts/discover-tfl-cameras.js
 * 
 * Output: writes to tfl-cameras.json in the project root
 */
